...
echo "    Manual:  github.com/evaleev/libint/wiki" >> .messages.txt
echo "    GitHub:  github.com/evaleev/libint" >> .messages.txt
echo "    Binary:  anaconda.org/pyqc/libint" >> .messages.txt
